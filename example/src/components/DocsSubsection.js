    ...
    return (
        <div className='docs-subsection'>
            ...
            <div className='refer' ref={sectionRefs[ROUTES.INSTALL_NPM]}>
                ...
                <p>
                    Use our official libraries for access to the Pay Theory API
            ...
            <div className='refer' ref={sectionRefs[ROUTES.USAGE_IMPORT]}>
                ...
                <p>
                    Import our React Hooks and components to be used in your
                    App:
                </p>
                <ul>
                    <li>
                        <b>CreditCardProvider</b> is a component where you
                        provide configuration; it provides the necessary context
                        for payment processing
                    </li>
                    <li>
                        <b>CreditCardInput</b> is a component that establishes
                        the markup where the credit card input will appear
                    </li>
                    <li>
                        <b>usePayTheory</b> is a function that returns the
                        context needed for working with payments, it provides:
                        <ul>
                            <li>
                                loading - a boolean state value that changes to
                                false once pay theory is ready
                            </li>
                            <li>
                                valid - can be undefined, true or false based on
                            ...
                            <li>
                                mount - a function which will mount the payment
                                input (must be called after CreditCardInput has
                                been rendered)
                            </li>
                            <li>
                                initTransaction - a function which accepts an
                                optional buyerOptions object and triggers card
            ...
            <div className='refer' ref={sectionRefs[ROUTES.USAGE_CONFIGURE]}>
                ...
                <p>
                    These parameters are required before processing a payment
                    using <b>CreditCardProvider</b>.
                </p>
                <ul>
            ...
            <div
                className='refer'
                ref={sectionRefs[ROUTES.USAGE_PROCESS_PAYMENTS]}
            >
                <Link
                    to={{
                ...
                <p>
                    Calling these functions will allow you to process a payment.
                </p>
                <ul>
                    <li>to initialize, the form mount() is called once</li>
                    <li>
                        when the form is ready for submission, call
                        initTransaction and pass in optional buyerOptions
                    </li>
                    <li>
